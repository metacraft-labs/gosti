...
2. the **vm-harness ephemeral Incus capability flags** a trusted controller
   sends to a remote host, and
3. the **GARM Incus provider options** (`incus*`) a fleet operator sets to grant
